...
//
    QSqlQuery* query = new QSqlQuery(db);
      query->prepare("SELECT * FROM TRANSACTION_ATM WHERE source_account_number = " + _sessionManager.getActiveCardNumber() + " OR destination_account_number = " + _sessionManager.getActiveCardNumber());
      query->exec();
