...
public:
    CreditAccount();
    CreditAccount(int creditTerm, double creditDept, int userId, QString cardNumber, QString pin, QString cvv, double sumOnBalance, int limit, bool isBlocked, QString expiryDate, QString creditExpiryDate = "");
    ~CreditAccount();
